                        ...
                        <table id="table" class="table table-bordered dt-responsive  nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#UpModal" > Edit</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/master/customer" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama</label>
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Enter Your Name" value="{{$c->nama}}">
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="alamat" class="form-label">Alamat</label>
                                    <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Enter Your Adress" value="{{$c->alamat}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="number" class="form-label">No HP</label>
                                    <input type="number" class="form-control" id="number" name="no_hp" placeholder="Enter Your Number" value="{{$c->no_hp}}">
                                </div>
                            </div>
                        </div>
