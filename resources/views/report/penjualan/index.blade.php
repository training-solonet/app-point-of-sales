                    ...
                    <div class="table-responsive">
                        <div class="btn-group mb-3">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item disabled" href="#" aria-disabled="true"><i class="bx bx-money"></i> Bayar</a>
                        ...
                        <form class="mt-3 mb-5">
                            <div class="mb-4">
                                ...
                                <select class="select2 form-control select2-multiple" name="filter_customer" multiple="multiple" data-placeholder="Pilih Nama">
